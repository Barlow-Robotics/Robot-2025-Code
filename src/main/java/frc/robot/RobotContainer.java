...
public class RobotContainer {
    ...
    public void configurePathPlanner() {
        ...
        Command autoAlignCommandLeft = dynAutoBuilder.trapezoidAlign(Constants.AutoConstants.LeftOffset, 3.0, 3.0, 0.07, 5);
        Command autoAlignCommandRight = dynAutoBuilder.trapezoidAlign(Constants.AutoConstants.RightOffset, 3.0, 3.0, 0.07, 5);
        Command autoAlignCommandCenter = dynAutoBuilder.trapezoidAlign(Constants.AutoConstants.AutoOffset, 0.07, 5);
