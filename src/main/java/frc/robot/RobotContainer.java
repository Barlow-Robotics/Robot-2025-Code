...
public class RobotContainer {
        ...
        private Alliance selectForAlliance() {
                return DriverStation.getAlliance().orElse(Alliance.Blue);
        }

        private Command buildAutoForAlliance(Function<Alliance, Command> makeAuto) {
                return new SelectCommand<>(
                                // Maps selector values to commands
                                Map.ofEntries(
                                                Map.entry(Alliance.Blue,
                                                                makeAuto.apply(Alliance.Blue)),
                                                Map.entry(Alliance.Red,
                                                                makeAuto.apply(Alliance.Red))),
                                this::selectForAlliance);
        }
        ...
        public void configurePathPlanner() {
                ...
                // What should this do?
                NamedCommands.registerCommand("Wait_5", Commands.waitSeconds(0));
                ...
                Supplier<Command> commandAlgaeL4 = () -> Commands.sequence(
                ...
                Supplier<Command> commandGroup1 = () -> Commands.sequence(
                ...
                Supplier<Command> autoAlignCommandLeft = () -> dynAutoBuilder.trapezoidAlign(
                                Constants.AutoConstants.LeftOffset, 3.0,
                                3.0);
                Supplier<Command> autoAlignCommandRight = () -> dynAutoBuilder.trapezoidAlign(
                                Constants.AutoConstants.RightOffset, 3.0,
                                3.0);
                Supplier<Command> autoAlignCommandCenter = () -> dynAutoBuilder
                                .trapezoidAlign(Constants.AutoConstants.AutoOffset);

                autoChooser.addOption("Leave Zone",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.ChoreoAuto("[USED] Leave Zone", alliance);
                                }));
                autoChooser.addOption("Score L1 Path",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.ChoreoAuto("[USED] Score L1 Path", alliance);
                                }));
                autoChooser.addOption("Score L3 Path",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.ChoreoAuto("[USED] Score L3 Path", alliance);
                                }));
                autoChooser.addOption("2-Coral-Current-Alliance",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.CustomChoreoAuto("[USED] 2CoralP", alliance, true,
                                                        setArmPosLevel1Cmd, commandGroup1.get(),
                                                        scoreCoralCmd, autoAlignCommandRight.get(),
                                                        autoAlignCommandCenter.get(), chuteHasCoral,
                                                        new PositionGripper(armState, ArmState.Level3,
                                                                        elevatorSub, armSub, wristSub));
                                }));

                autoChooser.addOption("2-Coral-Opposite-Alliance",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.CustomChoreoAuto("[USED] 2CoralP", alliance, false,
                                                        setArmPosLevel1Cmd,
                                                        commandGroup1.get(),
                                                        scoreCoralCmd, autoAlignCommandRight.get(),
                                                        autoAlignCommandCenter.get(),
                                                        chuteHasCoral,
                                                        new PositionGripper(armState, ArmState.Level3, elevatorSub,
                                                                        armSub,
                                                                        wristSub));
                                }));
                ...
                autoChooser.addOption("(L4) 2-Coral-Current-Alliance",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.CustomChoreoAutoL4("[USED] 2CoralP", alliance, true,
                                                        setArmPosLevel4Cmd, setArmPosTravellingCmd,
                                                        scoreCoralCmd, autoAlignCommandRight.get(),
                                                        autoAlignCommandLeft.get(), chuteHasCoral,
                                                        setArmPosLoadCoralCmd);
                                }));
                autoChooser.addOption("(L4) 2-Coral-Opposite-Alliance",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.CustomChoreoAutoL4("[USED] 2CoralP", alliance, false,
                                                        setArmPosLevel4Cmd,
                                                        setArmPosTravellingCmd,
                                                        scoreCoralCmd, autoAlignCommandRight.get(),
                                                        autoAlignCommandLeft.get(),
                                                        chuteHasCoral, setArmPosLoadCoralCmd);
                                }));

                autoChooser.addOption("1-Coral-L4-Right",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.ChoreoAuto1CoralL4("[USED] 1-Coral-L4", alliance,
                                                        autoAlignCommandRight.get(), scoreCoralCmd, setArmPosLevel4Cmd);
                                }));

                autoChooser.addOption("1-Coral-L4-Left",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.ChoreoAuto1CoralL4("[USED] 1-Coral-L4", alliance,
                                                        autoAlignCommandLeft.get(), scoreCoralCmd, setArmPosLevel4Cmd);
                                }));

                autoChooser.addOption("1-Coral-L4-Right-Algae",
                                buildAutoForAlliance((alliance) -> {
                                        return driveSub.ChoreoAuto1CoralL4WithAlgae("[USED] 1-Coral-L4", alliance,
                                                        autoAlignCommandRight.get(), scoreCoralCmd, setArmPosLevel4Cmd,
                                                        autoAlignCommandCenter.get(), commandAlgaeL4.get());
                                }));
