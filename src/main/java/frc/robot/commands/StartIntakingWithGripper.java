...
public class StartIntakingWithGripper extends Command {

    Gripper gripperSub;

    /** Creates a new Intake. */
    public StartIntakingWithGripper(Gripper gripperSub ) {
